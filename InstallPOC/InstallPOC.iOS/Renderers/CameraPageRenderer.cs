...
[assembly: ExportRenderer(typeof(CameraPage), typeof(InstallPOC.iOS.Renderers.CameraPageRenderer))]
		...
		public override void TouchesEnded(NSSet touches, UIEvent evt)
		{
			...
			if (touches.FirstOrDefault() is UITouch touch)
			{
				...
				if (captureDevice != null)
				{
					...
					var point = videoPreviewLayer.CaptureDevicePointOfInterestForPoint(location);
